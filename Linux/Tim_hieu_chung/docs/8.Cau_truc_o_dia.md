...
- Số thao tác đọc ghi trên ổ cứng trong 1s . Thông số này cùng với IO Size sẽ ính được throughput  . IO size có thể là 4KB , 8KB ,... . Lượng data nhỏ nhất có thể đọc ghi là bằng 1 sector , 512 byte.  
Ta có công thức :  
```
...
- So sánh :  
   ...
   - Kiểu ghi random có lợi thế hơn do data sẽ được đưa vào chỗ còn trống , điều này có lợi hơn khi dữ liệu thường xuyên bị modified .  
